...
#  https://github.com/kubeflow/pipelines/blob/2.1.0/samples/tutorials/Data%20passing%20in%20python%20components/Data%20passing%20in%20python%20components%20-%20Files.py
#
...
if __name__ == "__main__":
    compiler.Compiler().compile(
        data_passing_pipeline, "SAMPLE__Data-Passing-Python-Components.yaml"
    )
