...
#  https://github.com/kubeflow/pipelines/blob/2.1.0/samples/tutorials/DSL%20-%20Control%20structures/DSL%20-%20Control%20structures.py
#
...
if __name__ == "__main__":
    ...
    kfp.compiler.Compiler().compile(
        control_flows_pipeline, "SAMPLE__DSL-Control-Structures.yaml"
    )
